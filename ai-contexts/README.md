...
Diese Dateien sind **nicht** die Lang-Doku. Sie sind der Einstieg:
Wo anfangen? Was ist tabu?
...
- **WGX-Erwartung sichtbar**: Fleet-Repos sollen
...
- v1.0 hatte bereits: project / dependencies / architecture /
  conventions / documentation / ai_guidance.
- v1.1 ergänzt: heimgewebe (Achse/Fleet/WGX), interfaces
  (produces/consumes), contracts, boundaries.

## Rollout-Regel (wichtig)

Dieses Verzeichnis `ai-contexts/` ist **metarepo-zentriert** gedacht:
hier liegen Templates und Beispiele.
...
- Der CI-Guard ist so gebaut, dass er Template-Checks nur ausführt,
  wenn `ai-contexts/` existiert.
